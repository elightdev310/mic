...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $paymentinfo->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("PaymentInfos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/paymentinfos/'.$paymentinfo->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("PaymentInfos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.paymentinfos.destroy', $paymentinfo->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/paymentinfos') }}" data-toggle="tooltip" data-placement="right" title="Back to PaymentInfos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'name_card')
						@la_display($module, 'cc_number')
						@la_display($module, 'exp')
						@la_display($module, 'cid')
