...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $claimactivity->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("ClaimActivities", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/claimactivities/'.$claimactivity->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("ClaimActivities", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.claimactivities.destroy', $claimactivity->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/claimactivities') }}" data-toggle="tooltip" data-placement="right" title="Back to ClaimActivities"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'public_patient')
					</div>
				</div>
			</div>
		</div>
