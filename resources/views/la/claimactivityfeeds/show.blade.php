...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $claimactivityfeed->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("ClaimActivityFeeds", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/claimactivityfeeds/'.$claimactivityfeed->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("ClaimActivityFeeds", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.claimactivityfeeds.destroy', $claimactivityfeed->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/claimactivityfeeds') }}" data-toggle="tooltip" data-placement="right" title="Back to ClaimActivityFeeds"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'feeder_uid')
						@la_display($module, 'ca_id')
					</div>
				</div>
			</div>
		</div>
