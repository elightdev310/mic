...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $subscription->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Subscriptions", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/subscriptions/'.$subscription->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Subscriptions", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.subscriptions.destroy', $subscription->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/subscriptions') }}" data-toggle="tooltip" data-placement="right" title="Back to Subscriptions"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'plan')
						@la_display($module, 'trial_ends_at')
						@la_display($module, 'ends_at')
					</div>
				</div>
			</div>
		</div>
