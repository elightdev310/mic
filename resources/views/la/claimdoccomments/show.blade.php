...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $claimdoccomment->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("ClaimDocComments", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/claimdoccomments/'.$claimdoccomment->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("ClaimDocComments", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.claimdoccomments.destroy', $claimdoccomment->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/claimdoccomments') }}" data-toggle="tooltip" data-placement="right" title="Back to ClaimDocComments"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'doc_id')
						@la_display($module, 'author_uid')
						@la_display($module, 'p_comment_id')
					</div>
				</div>
			</div>
		</div>
