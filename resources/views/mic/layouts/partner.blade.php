...
@show
<body class="sidebar-collapse @hasSection('page_id')@yield('page_id')@endif @hasSection('page_classes')@yield('page_classes')@endif {{ MICUILayoutHelper::getRoleClass() }} partner-page">
<div class="wrapper">
