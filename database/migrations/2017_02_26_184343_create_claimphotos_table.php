...
class CreateClaimphotosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Claimphotos", 'claimphotos', 'file_id', 'fa-cube', [
    ...
    {
        if (Schema::hasTable('claimphotos')) {
            Schema::drop('claimphotos');
        }
    }
}
