...
class CreatePaymentinfosTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Paymentinfos", 'paymentinfos', 'name_card', 'fa-dollar', [
            ["name_card", "Name on Card", "String", false, "", 0, 50, false],
            ["cc_number", "Credit Card Number", "String", false, "", 0, 50, false],
            ["exp", "Exp", "String", false, "", 0, 50, false],
            ["cid", "CID", "String", false, "", 0, 50, false],
    ...
    {
        if (Schema::hasTable('paymentinfos')) {
