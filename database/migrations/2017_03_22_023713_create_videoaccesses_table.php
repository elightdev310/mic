...
class CreateVideoaccessesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Videoaccesses", 'videoaccesses', 'video_id', 'fa-cube', [
            ["video_id", "Video ID", "Integer", false, "0", 0, 4294967295, false],
    ...
    {
        if (Schema::hasTable('videoaccesses')) {
            Schema::drop('videoaccesses');
        }
    }
}
