...
class CreateIquestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Iquestions", 'iquestions', 'quiz', 'fa-question', [
            ...
            ["show_creating", "Show in Creating", "Integer", false, "1", 0, 7, false],
    ...
    {
        if (Schema::hasTable('iquestions')) {
            Schema::drop('iquestions');
        }
    }
}
