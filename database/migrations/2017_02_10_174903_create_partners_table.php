...
class CreatePartnersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Partners", 'partners', 'first_name', 'fa-diamond', [
            ["first_name", "First Name", "String", false, "", 0, 50, true],
            ["last_name", "Last Name", "String", false, "", 0, 50, true],
            ["company", "Company Name", "String", false, "", 0, 256, false],
            ["phone", "Phone Number", "String", false, "", 0, 50, false],
            ["address", "Address", "String", false, "", 0, 256, false],
            ["address2", "Address 2", "String", false, "", 0, 256, false],
            ["city", "City", "String", false, "", 0, 100, false],
            ["state", "State", "String", false, "", 0, 50, false],
            ["zip", "Zip Code", "String", false, "", 0, 20, false],
            ["membership_role", "Membership Role", "Dropdown", false, "", 0, 0, false, ["attorney","pcp","ts","other"]],
            ["membership_level", "Membership Level", "String", false, "", 0, 20, false],
            ["payment_type", "Payment Type", "Dropdown", false, "", 0, 0, false, ["paypal","visa"]],
            ["payment_info_id", "Payment Information", "Dropdown", false, "", 0, 0, false, "@paymentinfos"],
