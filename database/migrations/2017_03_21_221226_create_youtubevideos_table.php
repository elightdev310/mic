...
class CreateYoutubevideosTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Youtubevideos", 'youtubevideos', 'vid', 'fa-cube', [
            ["vid", "Video ID", "String", false, "", 0, 256, false],
            ["vdata", "Video Data", "Textarea", false, "", 0, 0, false],
        ]);
    ...
    {
        if (Schema::hasTable('youtubevideos')) {
