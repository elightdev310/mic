...
class PartnersController extends Controller
{
	...
	public $listing_cols = ['id', 'first_name', 'last_name', 'company', 'phone', 'address', 'address2', 'city', 'state', 'zip', 'membership_role', 'membership_level', 'payment_type', 'payment_info_id', 'user_id'];
